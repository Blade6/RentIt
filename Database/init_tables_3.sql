...
values ('YueA12345','pictures/YueA12345.jpg','car','HONDA',5,'white',150,150000,0,0);
insert into car (license_no,picture,type,brand,seat_number,color,rent_fare,value,flag,num)
values ('YueF12580','pictures/YueF12580.jpg','truck','VOLKSWAGEN',2,'white',125,120000,0,0);
insert into car (license_no,picture,type,brand,seat_number,color,rent_fare,value,flag,num)
values ('YueB16520','pictures/YueB16520.jpg','car','BMW',5,'black',385,350000,0,0);
insert into car (license_no,picture,type,brand,seat_number,color,rent_fare,value,flag,num)
values ('YueB20416','pictures/YueB20416.jpg','car','TOYATA',5,'red',260,250000,0,0);
insert into car (license_no,picture,type,brand,seat_number,color,rent_fare,value,flag,num)
values ('YueA20127','pictures/YueA20127.jpg','car','BENZ',5,'blue',425,400000,0,0);
insert into car (license_no,picture,type,brand,seat_number,color,rent_fare,value,flag,num)
values ('YueA39753','pictures/YueA39753.jpg','car','VOLKSWAGEN',5,'grey',395,380000,0,0);
...
insert into user (identity,username,password,name,picture,gender,age,phone_num,accident_num,flag,checked)
values ('440221199505201918','Cooper','cd21b93cfd8d6824dc2bce1a19decaf7','面具','440221199505201918/V.jpeg','男',21,'13713652324',0,0,1;
insert into user (identity,username,password,name,picture,gender,age,phone_num,accident_num,flag,checked)
...
insert into board (user_ID,date,time,content)
...
values ('root','098f6bcd4621d373cade4e832627b4f6');