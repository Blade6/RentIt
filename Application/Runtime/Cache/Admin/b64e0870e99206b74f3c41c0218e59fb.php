...
<html lang="en">
  ...
  <body>
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <script type="text/javascript">
          switch("/RCW_MVC/index.php/Admin/Admin/edit/id/1/adminName/root/password/098f6bcd4621d373cade4e832627b4f6.html"){
	...
	<div class="BeInCenter">
		...
		<form action="<?php echo U('Admin/edit');?>" method="post" class="form-horizontal" role="form">
