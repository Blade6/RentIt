...
<html lang="en">
  ...
  <body>
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <script type="text/javascript">
          switch("/RCW_MVC/index.php/Admin/Admin/index.html"){
	...
	<div class="BeInCenter">
		<form action="<?php echo U('Admin/search');?>" method="post" class="form-horizontal" role="form">
			<div class="form-group">
				<label>AdminName:</label>
				<input type="text" name="adminName">
				<button class="btn btn-primary" type="submit" name="search">查询</button>
				<a class="btn btn-default" href="<?php echo U('Admin/add');?>">添加管理员</a>
			</div>
		</form>
	</div>
