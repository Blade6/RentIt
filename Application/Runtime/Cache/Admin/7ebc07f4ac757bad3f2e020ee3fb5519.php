...
<html lang="en">
  <head>
    ...
    <!-- Bootstrap core CSS -->
    <link href="/RentIt_DE/Public/css/bootstrap.min.css" rel="stylesheet">

    <!-- Custom styles for this template -->
    <link href="/RentIt_DE/Public/css/dashboard.css" rel="stylesheet">

    <!-- 自定义css -->
    <link href="/RentIt_DE/Public/css/global.css" rel="stylesheet">

    <!-- Just for debugging purposes. Don't actually copy these 2 lines! -->
    <!--[if lt IE 9]><script src="../../assets/js/ie8-responsive-file-warning.js"></script><![endif]-->
    <script src="/RentIt_DE/Public/js/ie-emulation-modes-warning.js"></script>
  ...
  <body>
    <?php session('[start]'); $time=15*60; setcookie(session_name(),session_id(),time()+$time,"/"); if(empty($_SESSION["admin"])){ echo "<script>alert('非法操作!');</script>"; echo "<script>window.location='/RentIt_DE/index.php/Admin/Index/index';</script>"; } ?>
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <script type="text/javascript">
          switch("/RentIt_DE/index.php/Admin/Message/postSearch.html"){
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          	<h2 class="sub-header"><?php echo ($topic); ?></h2>
	...
	<div class="table-reposive">
		<table class="table table-striped">
			...
			<tbody>
				<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><form action="<?php echo U('Message/postDelete');?>" method="post">
						<tr>
							<td><?php echo ($data["id"]); ?><input type="hidden" value="<?php echo ($data["id"]); ?>" name="id"></td>
							<td><?php echo ($data["userid"]); ?></td>
							<td><?php echo ($data["floor"]); ?></td>
							<td>
								<?php if($data["refloor"]!=0) echo $data["refloor"]."楼"; else echo "None"; ?>
							</td>
	...
	<div>
		<a class="btn btn-primary" href="<?php echo U('Message/post',array('col'=>$col,'topic'=>$topic));?>">返回</a>
	</div>
        </div>
      </div>
    </div>
    ...
    <script src="/RentIt_DE/Public/js/jquery-3.1.1.min.js"></script>
    <script src="/RentIt_DE/Public/js/bootstrap.min.js"></script>
    <script src="/RentIt_DE/Public/js/docs.min.js"></script>
    <!-- IE10 viewport hack for Surface/desktop Windows 8 bug -->
    <script src="/RentIt_DE/Public/js/ie10-viewport-bug-workaround.js"></script>
  </body>
</html>