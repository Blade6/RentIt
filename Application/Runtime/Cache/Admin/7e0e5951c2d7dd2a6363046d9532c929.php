  ...
  <body>
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <script type="text/javascript">
          switch("/RCW_MVC/index.php/Admin/User/search.html"){
	...
	<div class="table-reposive">
		<table class="table table-striped">
			...
			<tbody>
				<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><form action="<?php echo U('User/generalManage');?>" method="post" onsubmit="return sure()">
						<tr>
							<td>
	...
	<div>
		<a class="btn btn-success" href="<?php echo U('User/index');?>">返回</a>
	</div>
	<script type="text/javascript">
		function sure(){
