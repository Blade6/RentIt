...
<html lang="en">
  ...
  <body>
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <script type="text/javascript">
          switch("/RentIt/index.php/Admin/Car/add.html"){
	...
	<div class="BeInCenter">
		<div class="content">
			<form class="form-horizontal" action="<?php echo U('Car/add');?>" method="post" role="form">
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input class="form-control" type="number" name="rent_fare">
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
				    <div class="col-sm-offset-2 col-sm-10">
				    	<button type="submit" class="btn btn-success" name="add">添加</button>
				    </div>
				</div>
			</form>
		</div>
