    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <script type="text/javascript">
          switch("/RentIt/index.php/Admin/Car/edit/license_no/YueA12345.html"){
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          	<h2 class="sub-header">车辆管理</h2>
	<div class="BeInCenter">
		<h3>修改License=<?php echo ($data["license_no"]); ?>的记录:</h3>
		<!-- 基本信息 -->
		<div class="baseInfo">
			<div class="content">
				<form class="form-horizontal" action="<?php echo U('Car/edit');?>" method="post" role="form">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input class="form-control" type="text" name="brand" value="<?php echo ($data["brand"]); ?>">
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label">Seat</label>
						<div class="col-sm-10">
							<input class="form-control" type="text" name="seat_number" value="<?php echo ($data["seat_number"]); ?>">
						</div>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
					    <div class="col-sm-offset-2 col-sm-10">
					    	<input type="hidden" name="license_no" value="<?php echo ($data["license_no"]); ?>">
		...
		<!-- 修改图片 -->
		<div class="changeCarPic">
			<div>
				<label>当前图片:</label><br>
				<img src="/RentIt/Public/pictures/<?php echo ($data["picture"]); ?>" class="car-pic-lg">
			</div>
			<br>
			<form action="<?php echo U('Car/edit');?>" method="post" enctype='multipart/form-data' role="form">
				<label>更换图片:</label>
				<input type="file" name="car-img">
				<input type="hidden" name="license_no" value="<?php echo ($data["license_no"]); ?>">
				<button class="btn btn-success btn-top" type="submit" name="changePic">确定</button>
			</form>
		</div>
	</div>
        </div>
