    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <script type="text/javascript">
          switch("/RentIt/index.php/Admin/Accident/edit/id/1/rentid/1/userid/440221199505201918/license_no/YueA12345/date/2014-07-31/place/Guangzhou+city+Panyu+district.html"){
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
              <h2 class="sub-header">Accident管理</h2>
    <div class="BeInCenter">
        <h3>修改id=<?php echo ($id); ?>的记录:</h3>
        <div class="content">
            <form action="<?php echo U('Accident/edit');?>" method="post" class="form-horizontal" role="form">
                <div class="form-group">
                    <label class="col-sm-2 control-label">租车条目:</label>
                    <div class="col-sm-10">
                        <input class="form-control" type="text" name="rent_id" value="<?php echo ($rentid); ?>" size="8" maxlength="10">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label">用户身份证号:</label>
                    <div class="col-sm-10">
                        <input class="form-control" type="text" name="user_id" value="<?php echo ($userid); ?>" size="18" maxlength="18">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label">车牌号:</label>
                    <div class="col-sm-10">
                        <input class="form-control" type="text" name="license_no" value="<?php echo ($license_no); ?>" size="9" maxlength="9">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label">日期:</label>
                    <div class="col-sm-10">
                        <input class="form-control" type="text" name="date" value="<?php echo ($date); ?>" size="10" maxlength="10">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-2 control-label">地点:</label>
                    <div class="col-sm-10">
                        <input class="form-control" type="text" name="place" value="<?php echo ($place); ?>" size="30" maxlength="60">
                    </div>
                </div>
                <div class="form-group">
