...
<html lang="en">
  ...
  <body>
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <script type="text/javascript">
          switch("/RentIt/index.php/Admin/Car/index.html"){
	...
	<div class="BeInCenter">
		<form action="<?php echo U('Car/search');?>" method="post" class="form-horizontal" role="form">
			<div class="form-group">
				...
				<a class="btn btn-default" href="<?php echo U('Car/add');?>">添加车辆</a>
			</div>
		</form>
	</div>
	<div class="table-reposive">
		<table class="table table-striped">
			...
			<tbody>
				<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><form action="<?php echo U('Car/manage');?>" method="post">
						<tr>
							<td>
							...
							<td><img class="car-pic" src="/RentIt/Public/pictures/<?php echo ($data["picture"]); ?>"></td>
							<td><button class="btn btn-success" type="submit" name="edit_1">修改</button></td>
							<td><button class="btn btn-danger" type="submit" name="delete" onclick="return sure()">永久删除</button></td>
						</tr>
