...
<html lang="en">
  ...
  <body>
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <script type="text/javascript">
          switch("/RentIt/index.php/Admin/Car/superEdit/license_no/YueB56824.html"){
	...
	<div class="BeInCenter">
		...
		<div class="content">
			<form class="form-horizontal" action="<?php echo U('Car/superEdit');?>" method="post" role="form">
				<div class="form-group">
					<label class="col-sm-2 control-label">单日租金</label>
					<div class="col-sm-10">
						<input class="form-control" type="number" name="rent_fare" value="<?php echo ($data["rent_fare"]); ?>">
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					<label class="col-sm-2 control-label">是否被租</label>
					<div class="col-sm-10">
				...
				<div class="form-group">
					<label class="col-sm-2 control-label">出租次数</label>
					<div class="col-sm-10">
						<input class="form-control" type="number" name="num" value="<?php echo ($data["num"]); ?>" min="0">
					</div>
				</div>
				<div class="form-group">
