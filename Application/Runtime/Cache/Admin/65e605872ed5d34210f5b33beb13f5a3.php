...
<html lang="en">
  ...
  <body>
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <script type="text/javascript">
          switch("/RCW_MVC/index.php/Admin/User/index.html"){
	...
	<div class="BeInCenter">
		<form action="<?php echo U('User/search');?>" method="post" class="form-horizontal" role="form">
	...
	<div class="table-reposive">
		<table class="table table-striped">
			...
			<tbody>
				<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><form action="<?php echo U('User/delete');?>" method="post" onsubmit="return sure()">
						<tr>
							<td>
								<?php echo ($data["identity"]); ?>
								<input type="hidden" value="<?php echo ($data["identity"]); ?>" name="identity">
							</td>
							<td><?php echo ($data["username"]); ?></td>
							<td><?php echo ($data["password"]); ?></td>
							<td><img class="user-pic" src="/RCW_MVC/Public/user_pics/<?php echo ($data["picture"]); ?>"></td>
							<td>								
								<button class="btn btn-danger" type="submit" name="delete">永久删除</button>
							</td>
						</tr>
