...
<html lang="en">
  ...
  <body>
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <script type="text/javascript">
          switch("/RCW_MVC/index.php/Admin/Admin/add.html"){
	...
	<div class="BeInCenter">
		<form action="<?php echo U('Admin/add');?>" method="post" class="form-horizontal" role="form">
			<label>管理员名称:</label>
			<input type="text" name="adminName" maxlength="20">&nbsp&nbsp&nbsp
			<label>密码:</label>
			<input type="password" name="password" maxlength="20">&nbsp&nbsp&nbsp
