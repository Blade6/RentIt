...
<html lang="en">
  ...
  <body>
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <script type="text/javascript">
          switch("/RentIt/index.php/Admin/Rent/superEdit/id/1.html"){
	...
	<div class="BeInCenter">
		...
		<div class="content">
			<form action="<?php echo U('Rent/superEdit');?>" method="post" class="form-horizontal" role="form">
				<div class="form-group">
					<label class="col-sm-2 control-label">还车日期</label>
					<div class="col-sm-10">
						<input class="form-control" type="date" name="return_date" value="<?php echo ($data["return_date"]); ?>">
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-2 control-label">缴纳金</label>
					<div class="col-sm-10">
						<input class="form-control" type="number" name="penalty" value="<?php echo ($data["penalty"]); ?>">
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-2 control-label">收取缴纳金</label>
					<div class="col-sm-10">
						<?php if(!$data["p_flag"]){ echo "<input type=\"radio\" name=\"p_flag\" value=\"1\">是"; echo "<input type=\"radio\" name=\"p_flag\" value=\"0\" checked=\"true\">否"; }else{ echo "<input type=\"radio\" name=\"p_flag\" value=\"1\" checked=\"true\">是"; echo "<input type=\"radio\" name=\"p_flag\" value=\"0\">否"; } ?>
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-2 control-label">总租金</label>
					<div class="col-sm-10">
						<input class="form-control" type="number" name="fare" value="<?php echo ($data["fare"]); ?>">
					</div>
				</div>
				<div class="form-group">
					<label class="col-sm-2 control-label">支付租金</label>
					<div class="col-sm-10">
						<?php if(!$data["fare_flag"]){ echo "<input type=\"radio\" name=\"fare_flag\" value=\"1\">是"; echo "<input type=\"radio\" name=\"fare_flag\"  value=\"0\" checked=\"true\">否"; }else{ echo "<input type=\"radio\" name=\"fare_flag\" checked=\"true\" value=\"1\">是"; echo "<input type=\"radio\" name=\"fare_flag\" value=\"0\">否"; } ?>
					</div>
				</div>
				<div class="form-group">
