  ...
  <body>
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <script type="text/javascript">
          switch("/RCW_MVC/index.php/Admin/User/superManage.html"){
	...
	<div class="table-reposive">
		<table class="table table-striped">
			...
			<tbody>
				<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><form action="<?php echo U('User/superManage');?>" method="post">
						<tr>
							<th><?php echo ($data["identity"]); ?></th>
							<td>
								<?php if(!$data["flag"]) echo "否"; else echo "是"; ?>
							</td>
							<td>
								<?php switch($data["checked"]){ case 1: echo "已核验"; break; case 0: echo "核验中"; break; case -1: echo "未核验"; break; default: break; } ?>
							</td>
							<td><?php echo ($data["accident_num"]); ?></td>
							<td>
								<input type="hidden" value="<?php echo ($data["identity"]); ?>" name="identity">								
								<button class="btn btn-success" type="submit" name="edit_2">修改</button>
							</td>
						</tr>
