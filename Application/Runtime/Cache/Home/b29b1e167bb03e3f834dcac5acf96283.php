			...
			<div id="navbar" class="collapse navbar-collapse">
				<ul class="nav navbar-nav">
					...
					<script type="text/javascript">
						switch("/RCW_MVC/index.php/Home/Rent/index.html"){
...
<div class="container">
		...
		<div class="bodyPart">
			<ul class="list-unstyled">
				<?php if(is_array($cars)): $i = 0; $__LIST__ = $cars;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cars): $mod = ($i % 2 );++$i;?><li>
						<div class="carLeft">
							<img class="carImg" src="/RCW_MVC/Public/<?php echo ($cars["picture"]); ?>">
						</div>
  ...
  <div class="headframe">
        <div class="center head">
          <img src="/RCW_MVC/Public/image/car.png" width="100">
        </div>
        <div>
          <ul class="list-unstyled">
            <li>
              <div class="contentli">
                <div class="leftpart center">
                  <img src="/RCW_MVC/Public/image/money.jpg" class="right-img">
                </div>
                <div class="rightpart">           
            ...
            <li>
              <div class="contentli">
                <div class="leftpart center">
                  <img src="/RCW_MVC/Public/image/customer.jpg" class="right-img">
                </div>
                <div class="rightpart">
            ...
            <li>
              <div class="contentli">
                <div class="leftpart center">
                  <img src="/RCW_MVC/Public/image/rent.jpg" class="right-img">
                </div>
                <div class="rightpart">
            ...
            <li>
              <div class="contentli">
                <div class="leftpart center">
                  <img src="/RCW_MVC/Public/image/service.jpg" class="right-img">
                </div>
                <div class="rightpart">
