			...
			<div id="navbar" class="collapse navbar-collapse">
				<ul class="nav navbar-nav">
					...
					<script type="text/javascript">
						switch("/RCW_MVC/index.php/Home/Me/keydata.html"){
...
<div class="container Min-height">
		...
		<div class="MyItem">
			<ul class="Item-nav list-unstyled">
				<li class="li">
					<a class="nav-a" href="<?php echo U('Me/index');?>">
						<span class="glyphicon glyphicon-home"> 欢迎页</span>
					</a>
				</li>
				<li class="li">
					<a class="nav-a" href="<?php echo U('Me/order');?>">
						<span class="glyphicon glyphicon-th"> 我的订单</span>
					</a>
				</li>
				<li class="li">
					<a class="nav-a" href="<?php echo U('Me/info');?>">
						<span class="glyphicon glyphicon-user"> 我的资料</span>
					</a>
				</li>
				<li class="li">
					<a class="nav-a" href="<?php echo U('Me/accident');?>">
						<span class="glyphicon glyphicon-exclamation-sign"> 违章记录</span>
					</a>
				</li>
				<li class="li">
					<a class="nav-a" href="<?php echo U('Me/keydata');?>">
						<span class="glyphicon glyphicon-edit"> 修改会员</span>
					</a>
				</li>
			</ul>
		</div>
