	...
	<div class="MyContent">
		<div class="MyContainer">
			...
			<div class="change_password none">
				<form action="<?php echo U('Me/info');?>" method="post" class="form-horizontal" role="form">
					<div class="form-group form-group-lg has-success">
						...
						<div class="col-md-10">
							<input class="form-control" type="password" placeholder="请输入原密码" name="password1">
						</div>
					</div>
					<div class="form-group form-group-lg has-success">
						<label class="col-md-2 control-label">新密码</label>
						<div class="col-md-10">
							<input class="form-control" type="password" placeholder="请输入新密码" name="password2" maxlength="16">
						</div>
					</div>
					<div class="form-group">
						<div class="col-md-offset-2 col-md-5">
			...
			<div class="change_pic none">
				<div>
					<label>当前头像:</label><br>
					<img src="/RentIt/Public/user_pics/<?php echo ($userInfo["picture"]); ?>" class="user-pic">
				</div>
				<br>
